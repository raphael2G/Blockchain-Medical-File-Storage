                    ...
                    <div className="w-full md:flex-1 p-3">
                      <div className="flex flex-wrap -m-3">
                        ...
                        <div className="w-full p-3">
                          ...
                          <input
                            className="w-3/12 px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input"
                            type="text"
                            placeholder="Category"
                          />
                          <input
                            className="w-9/12 px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input"
                            type="text"
                            placeholder="Notes"
                          />
                        </div>
